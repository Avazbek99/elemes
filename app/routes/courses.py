...
def detail(id, dir_id=None, group_id=None):
    ...
    if direction_id and group_id is None:
        ...
        if not target_group_id:
            first_gr = Group.query.filter_by(direction_id=direction_id).order_by(Group.name).first()
            if first_gr:
    ...
    for ta in all_teacher_assignments:
        ...
        if should_add_lesson_type:
            ...
            if target_direction_id and curriculum_item and ta.lesson_type not in allowed_lesson_types:
